...
<main id="shop-inside-main" class="shop-inside-main">
    <?php
    $directory_arr = array(
        array(
            "name" => "Top",
                        ...
                        <div class="panel-scroll" data-lenis-prevent>
                            <div class="panel-container">
                                ...
                                <div class="panel-body">
                                    <img src="./assets/img/design/shop-inside-filter.jpg" alt="Shop Filter Mock Image">
                                </div>
                            </div>
                        </div>
                    </div>
