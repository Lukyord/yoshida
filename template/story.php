...
<main id="story-main" class="story-main template-main">
    <?php
    $directory_arr = array(
        array(
            "name" => "Top",
    ...
    <section class="sc story template">
        <div class="container xl">
            <div class="title">
                <h1 class="size-h4 weight-semibold">Story</h1>
            </div>
            ...
            <div class="template-2-sides break-lg">
                ...
                <div class="template-2-sides-aside template-filter">
                    ...
                    <div class="mobile-panel" id="story-category-filter-panel">
                        <div class="panel">
                            ...
                            <div class="panel-scroll" data-lenis-prevent>
                                <div class="panel-container">
                                    ...
                                    <div class="panel-body">
                                        <img src="./assets/img/design/story-category-filter.jpg" alt="Products Filter Mock Image">
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="mobile-panel" id="story-year-filter-panel">
                        <div class="panel">
                            <div class="panel-header hidden-device-md">
                                <div class="panel-close margin-left-auto">
                                    <i class="ic ic-close c-orange size-icon-20"></i>
                            ...
                            <div class="panel-scroll" data-lenis-prevent>
                                <div class="panel-container">
                                    <div class="panel-body">
                                        <img src="./assets/img/design/story-year-filter.jpg" alt="Products Filter Mock Image">
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <div class="template-2-sides-content main-content">
                    ...
                    <div class="template-2-sides-panel-ctrl hidden-device-md">
                        <div class="wrapper">
                            <a href="javascript:;" class="panel-trigger" data-target="story-category-filter-panel">
                                <i class="ic ic-filter c-orange"></i>
                                <p class="size-subtitle2">Narrow down</p>
                            </a>
                            <a href="javascript:;" class="panel-trigger" data-target="story-year-filter-panel">
